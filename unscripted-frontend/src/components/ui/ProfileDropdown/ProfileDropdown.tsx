    ...
    <div className="dropdown dropdown-end">
      <label tabIndex={0} className="avatar btn btn-circle btn-ghost">
        <div className="w-10 rounded-full">
          <Image
            src={`https://api.dicebear.com/7.x/initials/svg?seed=Abby&backgroundColor=00897b,00acc1,039be5,1e88e5,3949ab,43a047,5e35b1,7cb342,8e24aa,c0ca33,fb8c00,fdd835,ffb300`}
            width={40}
            height={40}
            alt="avatar"
          />
